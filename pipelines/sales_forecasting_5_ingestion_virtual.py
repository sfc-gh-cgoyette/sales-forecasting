...
background_data_df=pd.read_csv("./scratch/background_data_df.csv",index_col=[0])
lr_train_data_df=pd.read_csv("./scratch/lr_train_data_df.csv",index_col=[0]) 
lr_val_data_df=pd.read_csv(".scratch/lr_val_data_df.csv",index_col=[0])  
lr_prod_data_df=pd.read_csv(".scratch/lr_prod_data_df.csv",index_col=[0]) 

rf_train_data_df=pd.read_csv("./scratch/rf_train_data_df.csv",index_col=0)
rf_val_data_df=pd.read_csv("./scratch/rf_val_data_df.csv",index_col=0)
rf_prod_data_df=pd.read_csv("./scratch/rf_prod_data_df.csv",index_col=0)
...
with open('./scratch/column_spec.pkl', 'rb') as f:
    column_spec = pickle.load(f)

with open('./scratch/prod_column_spec.pkl', 'rb') as f:
    prod_column_spec = pickle.load(f)

with open('.scratch/background_column_spec.pkl', 'rb') as f:
...
tru = refresh_creds_create_workspace(os.getenv('URL'), os.environ.get('AUTH_TOKEN'))
...
with open('./scratch/feature_map.pkl', 'rb') as f:
